...
class ResourcePage extends StatefulWidget {
  ...
  const ResourcePage({super.key, required this.location});
    ...
    await showModalBottomSheet(
      ...
      return Padding(
          padding: const EdgeInsets.all(16.0),
            ...
            children: <Widget>[
              TextField(
                decoration: const InputDecoration(labelText: 'Enter video title'),
                onChanged: (value) {
                  setState(() {
                    _title = value;
                  });
          ...
          ? StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, pdfresult) {
                ...
                if (pdfresult.hasError) {
                  return const Center(child: Text('Error occurred while loading documents. Please try again later.'));
                }
          ...
          : StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, videoresult) {
                ...
                if (videoresult.hasError) {
                  return const Center(child: Text('Error occurred while loading videos. Please try again later.'));
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      title: Text(title),
                      subtitle: const Text('YouTube URL'),
                      onTap: () async {
...
class DocumentViewerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        color: const Color.fromARGB(255, 236, 162, 186),
        child: Center(
