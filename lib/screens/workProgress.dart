...
class WorkProgressPage extends StatefulWidget {
  ...
  const WorkProgressPage({super.key, required this.location});
        ...
        child: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
             ...
             if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
              return const Center(child: Text('No work progress updates available.'));
            }
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    trailing: const Icon(Icons.file_present, color: Colors.brown),
                    onTap: () async {
